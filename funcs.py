...
# Создаем пример текста резюме со всеми видами контактов
sample_resume_text = """
Резюме: Смирнов Иван Петрович
Дата рождения: 15.05.1990

Контакты для связи:
Телефон: +7 (999) 123-45-67
Доп. номер: 8-916-7654321
Почта: ivan.smirnov-work@example.com
Личный сайт: https://smirnov-ivan.dev
LinkedIn: https://linkedin.com/in/ivansmirnov
GitHub: www.github.com/ivansmirnov
Telegram: @ivan_s_dev
Skype: ivan.smirnov_skype
...
# Обрабатываем текст нашей функцией
anonymized_text = anonymize_contacts(sample_resume_text)
