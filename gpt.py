...
Найди блоки, начинающиеся с "Будет плюсом, если вы" или похожие по смыслу (например, "Дополнительно", "Желательно"). 
Захвати весь текст до следующего пустого абзаца или нового заголовка. 
Добавь этот текст **как единый пункт** в раздел "Требования". 
Сохрани все эмодзи и форматирование. 
Не дели блок на отдельные строки. 
Удаляй только названия этих блоков, чтобы в тексте остались только требования и их содержание.
