...
Если найдёшь блоки с заголовками или текстами, похожими по смыслу на:
"Будет плюсом", "Желательно", "Приветствуется", "Дополнительно" или другие синонимы,
перемести их содержимое в конец раздела Требования (если он есть).

Если раздел Требования отсутствует, создай его в конце текста перед блоком контактов.



Сохрани исходное форматирование, эмодзи и разметку.
