...
❌ Если в тексте есть упоминание условий оплаты (например: "отсрочка более 50 календарных дней" "отсрочка более 35 рабочих дней", "акты поквартально"), вакансия отсекается.
