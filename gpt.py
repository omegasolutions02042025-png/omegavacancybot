    ...
    messages = [
        {
            ...
            **2. Заголовок (`vacancy_title`):**
            2. Заголовок (`vacancy_title`):
            * Если в начале есть строка-заголовок (например, "🥇 Java разработчик..."), удали её из текста и верни в ключ "vacancy_title".  
            * ❗️Сохрани абсолютно все пробелы, эмодзи и символы — **не удаляй пробелы в начале или конце строки**.  
            * Если заголовка нет — верни None.
