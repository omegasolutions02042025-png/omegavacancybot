    ...
    messages = [
        {
            ...
            Правило 1 (Продолжительность): Отсечь, если продолжительность проекта не равна или менее 4-х месяцев. 
            Если указано более 3 месяцев, то в рамках этого промта будем считать, что это менее 4-х месяцев.
            Примеры для отсева: "3 месяца", "2 мес с продлением", "от 3 мес", "3+ мес" и т.п.
            Примеры для пропуска: "4 мес", "от 6 мес", "6+ мес" и т.п.
            Если написано 'от 3х месяцев +' — отсечь.
