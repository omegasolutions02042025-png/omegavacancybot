...
async def main():
    vacancy_text = """🥇 AN-8544 Бизнес аналитик (наш внутренний проект,БЫСТРОЕ РАССМОТРЕНИЕ И ВЫВОД)

О кандидате:
Стек: Бизнес аналитик
Грейд: Senior
Опыт в годах:  от 3 лет 
Локация специалиста: РФ или РБ
Тайм-зона проекта: Москва
О проекте:
Внутренний проект RedLab
Оперативный вывод
Продолжительность проекта (от 3х месяцев): 6 мес +

Требования:
Опыт работы аналитиком 1C в производстве, логистике, FMCG, продажах
Опыт работы по разработке DWH
Опыт описания БП (нотация BPMN), моделирование сложных процессов.
Опыт составления проектной документации (ТЗ, ЧТЗ, БТ, ФТ)
Опыт работы в проектной команде
Опыт работы в BI системах (Power BI \ Tableu \ Qlik\ etc)
Опыт работы с 1С УТ, ERP, WMS, УАТ
Опыт работы с экстрактором 1С

Задачи:
Анализ действующей системы отчетности в продажах, финансах, логистики и производстве
Создание и адаптация новых форм отчетности из источников данных (1С, WMS)
Внедрение BI инструментов заказчику
Разработка аналитических отчетов Дашбордов
    """
