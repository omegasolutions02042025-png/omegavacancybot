    ...
    messages = [
        {
            ...
            Примеры для отсева: "Продолжительность проекта (от 3х месяцев): 3 месяца", "Продолжительность проекта (от 3х месяцев): 1 месяц с возможностью продления", "Продолжительность проекта (от 3х месяцев): 2 месяца с возможностью продления", "Продолжительность проекта (от 3х месяцев):1 мес", "Продолжительность проекта (от 3х месяцев):3 мес", "Продолжительность проекта (от 3х месяцев):от 3 мес", "Продолжительность проекта (от 3х месяцев): от 3х месяцев", "3+ мес".
            Примеры для пропуска: "Продолжительность проекта (от 3х месяцев):4 мес", "Продолжительность проекта (от 3х месяцев): от 6 мес", "Продолжительность проекта (от 3х месяцев):6+ мес".
