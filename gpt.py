...
❗️ **ГЛАВНОЕ ПРАВИЛО: Твоя основная задача — сохранить исходную структуру текста, включая ВСЕ абзацы (пустые строки между блоками текста) и переносы строк. Все удаления и изменения должны быть точечными. Не переписывай и не сокращай текст, который должен остаться.**
**КРИТЕРИИ ФИЛЬТРАЦИИ:**
