...
- Ежемесячная выплата Штат/Контракт: [сумма или "Рассматриваем ваши предложения"]
- С отсрочкой платежа "[срок, например: 35 рабочих дней]" после подписания акта ([Актирование ежемесячно/поквартальное/не указано]):
  ИП: [сумма или "Рассматриваем ваши предложения"],
  Самозанятый: [сумма или "Рассматриваем ваши предложения"]
