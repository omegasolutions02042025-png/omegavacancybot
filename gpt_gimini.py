...
— В этом случае пункты про уточнение имени, локации, даты рождения и зарплаты **не добавляются**.
...
async def generate_mail_for_candidate_utochnenie(json_data: dict):
  ...
  5️⃣ Заключение:
  -Возьми список {utochnenie} и кратко напиши что нужно уточнить кандидату для продолжения сверки. 
