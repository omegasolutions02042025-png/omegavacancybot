...
— Определи, какие страны указаны в тексте:
   * если есть РБ/Беларусь/Belarus/BY → добавь блок "Вариант 1. 🇧🇾";
   * если есть РФ/Россия/Russia/RU/Москва → добавь блок "Вариант 2. 🇷🇺";
...
Вариант 1. 🇧🇾💰 Месячная ставка для юр лица РБ:
Ежемесячная выплата Штат/Контракт (на руки) до: 130 000 RUB (с выплатой зарплаты 11 числа месяца следующего за отчетным)
С отсрочкой платежа "Срок уточняется" после подписания акта:
Актирование: поквартальное
1267 RUB/час (Gross)
ИП/Самозанятый: 211 000 RUB


Вариант 2. 🇷🇺💰 Месячная ставка для юр лица РФ:
Ежемесячная выплата Штат/Контракт (на руки) до: 130 000 RUB (с выплатой зарплаты 11 числа месяца следующего за отчетным)
С отсрочкой платежа "Срок уточняется" после подписания акта:
Актирование: поквартальное
1267 RUB/час (Gross)
