...
L) Если в тексте указана продолжительность проекта менее 6 месяцев (например: "3 месяца", "4 мес.", "полгода", "до 5 месяцев"), верни `short_project: true`.
   Если срок 6 месяцев или больше, либо не указан, верни `short_project: false`.
   
M) Если есть фраза вида "Отсрочка платежа ..." то верни её содержимое в переменной `delay_payment`, удаляя слова "Отсрочка платежа", кавычки и лишние пробелы.
