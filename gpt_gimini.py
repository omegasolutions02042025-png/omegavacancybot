...
B3. Выводи причину отсева в переменной reason.
B4. Если нет локации или гражданства — верни utochnenie - true
...
ЕСЛИ выполнено хотя бы одно условие отсева из блоков A или B, ИЛИ не выполнены C1,
