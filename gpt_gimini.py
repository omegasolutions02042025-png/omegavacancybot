...
"""
    ...
    1. Проведи сравнение по двум блокам: "Обязательные требования" и "Дополнительные требования" ("будет плюсом").
    ...
    3. Сделай итоговый вывод: "Полностью подходит", "Требуются уточнения", или "Отказ".
    4. Удали все личные данные из резюме.
