...
6. Проверь имя файла `{file_name}`:
   - Если в резюме нет имени/фамилии — ищи их в названии файла.
   - Если в названии файла есть число + "USD", "у.е.", "$" — считай это зарплатой (пример: `Ivan_Ivanov_3500USD.docx` → ставка 3500 USD).
