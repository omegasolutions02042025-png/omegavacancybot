...
5️⃣ **Блок уточнений:**  
Начни с фразы:  
«Чтобы завершить сверку и передать ваш профиль заказчику, пожалуйста, уточните:»  
...
«Также просим подтвердить:  
— ваши зарплатные ожидания (валюта и диапазон, без “на руки”);  
— контакты для оперативной связи (Telegram, телефон, e-mail);  
— готовность к выходу после оффера (сроки);  
— запланированный отпуск в ближайшие 6 месяцев;  
— формат оформления (штат, контракт, ИП, самозанятый);  
— просьба дополнить резюме, подробно описав проекты в формате:  
Компания / Проект | Период | Цель | Стек | Роль и задачи | Результаты.»
