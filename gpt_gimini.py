...
Это имя файла — важный источник данных. Используй его для извлечения:
— имени и фамилии (если в резюме не указаны);
— примерных зарплатных ожиданий (если указана сумма с валютой).
