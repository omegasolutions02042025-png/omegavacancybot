...
- Если у кандидата не указана дата рождения, имя и фамилия, зарплатные ожидания или контакты, то добавь в `compliance_check.must_have` пункты со статусом "Нет" и комментарием.
