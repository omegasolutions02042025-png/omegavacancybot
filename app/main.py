...
from agregator.app.db import get_all_slova, remove_slovo, add_message_mapping, remove_message_mapping, \
    get_all_message_mappings, get_next_sequence_number
from agregator.app.gpt import del_contacts_gpt
from agregator.app.kb import slova_kb, back_to_slova_menu_kb, slovo_kb
from db import (
    init_db,
    add_channel,
    remove_channel,
